...
const questions = [
  { text: 'Quando estou aprendendo algo novo, eu prefiro:', scale: 'ATI/REF', value: { a: 'ATI', b: 'REF' }, options: [ { image: '/gdrive-thumb/thumbnail?id=157iPnw51K-an6D5R04lN8Rp2UbFCHuza', description: 'Conversar sobre isso com outras pessoas.' }, { image: '/gdrive-thumb/thumbnail?id=1WJb-bKM4QxWFfYvbDSJomunDR9DZloak', description: 'Pensar sozinho sobre o assunto antes de falar com alguém.' } ] },
  { text: 'Se eu fosse professor, eu preferiria ensinar sobre:', scale: 'SEN/INT', value: { a: 'SEN', b: 'INT' }, options: [ { image: '/gdrive-thumb/thumbnail?id=17QO0TgXoIgEste5mcPCdHsDGtEe43JDy', description: 'Coisas do mundo real, como animais ou a natureza.' }, { image: '/gdrive-thumb/thumbnail?id=16XjuwFTxuyYc1dUjrCPJOl3CKDgoA5dF', description: 'Ideias e pensamentos, como imaginar coisas novas.' } ] },
  { text: 'Eu aprendo melhor quando vejo:', scale: 'VIS/VER', value: { a: 'VIS', b: 'VER' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1tdtnO2LKla61TdRIveh1zqMbUx7HH13M', description: 'Desenhos, fotos, gráficos e mapas.' }, { image: '/gdrive-thumb/thumbnail?id=1NbV1pWxWGsG_vjO4_bvK-UQyRpIF5cHY', description: 'Palavras escritas ou quando alguém me explica falando.' } ] },
  { text: 'Quando resolvo uma questão de Matemática, eu:', scale: 'SEQ/GLO', value: { a: 'SEQ', b: 'GLO' }, options: [ { image: '/gdrive-thumb/thumbnail?id=12PuQmgJtP__0BeSotQEmmMgomZ0GgaBu', description: 'Faço cada passo até chegar à resposta.' }, { image: '/gdrive-thumb/thumbnail?id=1muCVnnfo02qwKhQGGKwuI1Uw5Wn65KN-', description: 'Já sei a resposta, mas às vezes me atrapalho com os passos.' } ] },
  { text: 'Quando estou estudando com amigos, eu:', scale: 'ATI/REF', value: { a: 'ATI', b: 'REF' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1dJ-U99V9xVjsXmV3-IqR0WjB9N6vdXaU', description: 'Gosto de dar ideias e falar sobre o assunto.' }, { image: '/gdrive-thumb/thumbnail?id=13YwqTtAiqR_gAy3_hUaNSKgy490ArtRT', description: 'Prefiro ouvir e pensar antes de falar.' } ] },
  { text: 'Eu acho mais fácil aprender:', scale: 'SEN/INT', value: { a: 'SEN', b: 'INT' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1otZZFuR1uStTqY8_nD6-qgKuMhzJi39m', description: 'Fazendo experiências e testando.' }, { image: '/gdrive-thumb/thumbnail?id=1HL8TZA9Xy7P8En6HebluBAhdt2zwZv4q', description: 'Ouvindo explicações e entendendo a ideia.' } ] },
  { text: 'Quando leio um livro, eu:', scale: 'VIS/VER', value: { a: 'VIS', b: 'VER' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1qHB5Wd9Ov80MxdE-M_k0LOBV5VW1lj7f', description: 'Olho primeiro as figuras e desenhos.' }, { image: '/gdrive-thumb/thumbnail?id=1bggaJKBTaM5CjEiH5ob_pwZCWZt1NqNj', description: 'Leio primeiro o texto.' } ] },
  { text: 'Prefiro quando meu professor:', scale: 'SEQ/GLO', value: { a: 'SEQ', b: 'GLO' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1wvbeBVdByhcotDnMUICkwKf4mwEjVae-', description: 'Explica tudo passo a passo.' }, { image: '/gdrive-thumb/thumbnail?id=1Q2IOIxEu_ew2q6I6dJziKaECVJO458NT', description: 'Mostra o assunto todo e faz conexões com outras coisas.' } ] },
  { text: 'Meus amigos dizem que eu sou mais:', scale: 'ATI/REF', value: { a: 'ATI', b: 'REF' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1baNLs5cE3wVd3FOJC5_uvreLN6cPIvO9', description: 'Animado e gosto de conversar com todo mundo.' }, { image: '/gdrive-thumb/thumbnail?id=1Il_foB5ZiU9uPrMDXZAFwl1pNCDe8sTA', description: 'Calmo, gosto de ficar mais na minha.' } ] },
  { text: 'Gosto mais de livros que:', scale: 'SEN/INT', value: { a: 'SEN', b: 'INT' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1Ezwq-3ew1U3M_EQdcaBYGJtUhKAJxkuh', description: 'Me ensinam como fazer algo na prática.' }, { image: '/gdrive-thumb/thumbnail?id=1nWoHQ9nnBAgFT9D-8M4tgm8zEjjNiipr', description: 'Contem histórias ou ideias diferentes.' } ] },
  { text: 'Eu lembro melhor:', scale: 'VIS/VER', value: { a: 'VIS', b: 'VER' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1L8en6ok52o6G9JVs5Ky4sTix9S-RliN7', description: 'Das coisas que vejo (como cores e formas).' }, { image: '/gdrive-thumb/thumbnail?id=1JgT81WIoc2_Ow0wmeK6ennGn9tBXSc5F', description: 'Das coisas que ouço (como músicas ou histórias).' } ] },
  { text: 'Quando estou aprendendo algo novo, eu:', scale: 'SEQ/GLO', value: { a: 'SEQ', b: 'GLO' }, options: [ { image: '/gdrive-thumb/thumbnail?id=11d1J6f2bcmC3Uv4Npc9iXadP3N3xOj5Q', description: 'Aprendo aos poucos, um passo de cada vez.' }, { image: '/gdrive-thumb/thumbnail?id=18K_cSrERPWyUXrxbvy6o7AOCYZzKpp1T', description: 'Fico confuso no começo, mas depois tenho uma grande ideia de repente!' } ] },
  { text: 'Eu gosto mais de estudar:', scale: 'ATI/REF', value: { a: 'ATI', b: 'REF' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1i_axGZil0blcPtTS251Hc-tAizbtHCCO', description: 'Com amigos ou em grupo.' }, { image: '/gdrive-thumb/thumbnail?id=1B6xVyXaaxPzlEVUiLESIvjLuiTui43U0', description: 'Sozinho, no meu cantinho.' } ] },
  { text: 'Gosto mais de coisas que são:', scale: 'SEN/INT', value: { a: 'SEN', b: 'INT' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1ks8mhHIjPEXpKp43uxNabPieFS89rX5R', description: 'Reais (como plantas, brinquedos ou experimentos).' }, { image: '/gdrive-thumb/thumbnail?id=1yR3qSkD5VjJaLBVKjuw-Bj3RlSk_rTYO', description: 'Inventadas (como super-heróis, jogos de imaginação).' } ] },
  { text: 'Quando o professor mostra um desenho no quadro:', scale: 'VIS/VER', value: { a: 'VIS', b: 'VER' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1bPmu6ZtQs1S2a81QrDA1F9eqEIdbN2HW', description: 'Lembro mais da imagem.' }, { image: '/gdrive-thumb/thumbnail?id=10pHQpSOioTK6ouoghpB5LwJGou8UqoiF', description: 'Lembro mais do que ele explicou sobre ela.' } ] },
  { text: 'Quando aprendo algo novo, eu:', scale: 'SEQ/GLO', value: { a: 'SEQ', b: 'GLO' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1sp6GJcZ1CladJ9WFJf73zhrPMAJPoXlq', description: 'Gosto de focar só nisso até aprender bem.' }, { image: '/gdrive-thumb/thumbnail?id=1EL5Mijz3Tfs0OWYqj2denmbhED_UhBka', description: 'Gosto de pensar como isso se liga a outras coisas que já sei.' } ] },
  { text: 'Meus amigos dizem que eu sou mais:', scale: 'ATI/REF', value: { a: 'ATI', b: 'REF' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1Hcuoz7MC3RFhgVW109y0hTfk1tr6hNJw', description: 'Animado e gosto de conversar com todo mundo.' }, { image: '/gdrive-thumb/thumbnail?id=1zWIhMVPulOkJ4QuKDjwE9IBqqAYNVHT1', description: 'Calmo, gosto de ficar mais na minha.' } ] },
  { text: 'Gosto mais de aulas sobre:', scale: 'SEN/INT', value: { a: 'SEN', b: 'INT' }, options: [ { image: '/gdrive-thumb/thumbnail?id=12So9gs90pwd72dywZuhBT7_6OFswc462', description: 'Coisas que posso tocar ou ver (como animais, jogos).' }, { image: '/gdrive-thumb/thumbnail?id=11DaMc97rXVRH7WOWoY-4bL88FcdyF0pe', description: 'Coisas que imagino (como contos, estórias, invenções).' } ] },
  { text: 'Se alguém me explica algo, prefiro:', scale: 'VIS/VER', value: { a: 'VIS', b: 'VER' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1sjCBElK6b1mBQ7tASkHnnSJ9pSDKcP2t', description: 'Gráficos, desenhos ou cores.' }, { image: '/gdrive-thumb/thumbnail?id=1_SNUfcf43T1JgoKrB3976cUZfdlcbvQx', description: 'Um resumo escrito ou falado.' } ] },
  { text: 'Quando estou resolvendo um problema, eu:', scale: 'SEQ/GLO', value: { a: 'SEQ', b: 'GLO' }, options: [ { image: '/gdrive-thumb/thumbnail?id=1Pbfs9857ZS-DIc_JEJWE6-y3WdsgULIu', description: 'Penso nos passos para chegar à resposta.' }, { image: '/gdrive-thumb/thumbnail?id=1IE0SMTadgWnnfPGdf8bGXdkRUdLla2pU', description: 'Já penso no resultado e depois volto para os detalhes.' } ] }
];
